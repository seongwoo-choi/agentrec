...
**未リリース — プロンプト行に何ターン目かを表示:** ローカルストアのマルチターン
...
**未リリース — タスク通知はオペレーターの発話ではない:** Claude Code は完了した
...
**未リリース — 証拠リンクの説明文はボタンの下に:** アクションを選択するたびに、コピー
...
**未リリース — 実行見出しは最初の文で止まる:** ローカルストアではタイトル 35 件のうち
...
**未リリース — タイムラインパネルが画面に収まる:** タイムラインとインスペクターの
...
**未リリース — コンパクトな要約ストリップ:** タイムライン上の要約グリッドは 9 列のうち
