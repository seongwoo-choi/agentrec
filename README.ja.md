...
[リリースノート](docs/releases/v0.12.0.md) ·
...
> **ステータス:** 最新リリースは v0.12.0 です。ビューアーで全実行を検索すると、保存済みの
...
**未リリース — run 一覧の絞り込み:** プロジェクト名を完全一致で選ぶと、既存の `q`、
