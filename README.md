...
[Release notes](docs/releases/v0.11.0.md) ·
...
> **Status:** v0.11.0 is the latest release. Global Viewer search now finds
...
**Unreleased:** Changed-file search deep links preserve the matching file through
