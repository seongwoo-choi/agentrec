...
The latest tagged release is `v0.3.0`. It adds interactive session recording
for Claude Code and Codex from their hooks, pins repository evidence to Git's
defaults, and keeps redaction from growing a line past the stream limit.
