...
> **状态：** v0.10.1 是最新发布版本。文档列出的所有顶层命令现在都支持
> `-h` 和 `--help`；帮助选项不会执行命令本身，只会显示该命令的用法。
> v0.10.0 提供的有界 `list` → `show` → `changes` JSON 流程仍可继续用于
> 本地自动化。
>
...
- [v0.10.1 发布说明](docs/releases/v0.10.1.md) · [v0.10.0](docs/releases/v0.10.0.md) · [v0.9.0](docs/releases/v0.9.0.md) · [v0.8.0](docs/releases/v0.8.0.md) · [v0.7.1](docs/releases/v0.7.1.md) · [v0.7.0](docs/releases/v0.7.0.md) · [v0.6.0](docs/releases/v0.6.0.md) · [v0.5.0](docs/releases/v0.5.0.md) · [v0.4.0](docs/releases/v0.4.0.md) · [v0.3.0](docs/releases/v0.3.0.md) · [v0.2.0](docs/releases/v0.2.0.md) · [v0.1.0](docs/releases/v0.1.0.md)
