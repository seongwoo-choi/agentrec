...
> **状态：** v0.9.0 是最新发布版本。本地自动化现在可以完成整条机器可读的故障排查流程：
> 先用 `agentrec list --json` 查找运行，再用 `agentrec show <run-id> --json`，或与
> `--failures-only` 组合，读取限制大小并经过安全清理的证据。未经处理的提供方载荷仍不会输出。
>
...
- [v0.9.0 发布说明](docs/releases/v0.9.0.md) · [v0.8.0](docs/releases/v0.8.0.md) · [v0.7.1](docs/releases/v0.7.1.md) · [v0.7.0](docs/releases/v0.7.0.md) · [v0.6.0](docs/releases/v0.6.0.md) · [v0.5.0](docs/releases/v0.5.0.md) · [v0.4.0](docs/releases/v0.4.0.md) · [v0.3.0](docs/releases/v0.3.0.md) · [v0.2.0](docs/releases/v0.2.0.md) · [v0.1.0](docs/releases/v0.1.0.md)
