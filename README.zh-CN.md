...
> **状态：** v0.11.1 是最新发布版本。查看器的全局运行搜索现在可以找到已保存的
...
**尚未发布：** 指向具体操作的链接会保留操作 ID 及其所在分页的字节游标，刷新或使用浏览器的
