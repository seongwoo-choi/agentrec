...
> **状态：** v0.10.0 是最新发布版本。本地自动化现在可以先用 `agentrec list --json`
> 查找运行，再用 `agentrec show <run-id> --json` 检视，并且无需启动查看器即可通过
> `agentrec changes <run-id> --json` 获取准确的变更文件清单。补丁、文件内容和未经处理的
> 提供方载荷仍不会输出。
>
...
- [v0.10.0 发布说明](docs/releases/v0.10.0.md) · [v0.9.0](docs/releases/v0.9.0.md) · [v0.8.0](docs/releases/v0.8.0.md) · [v0.7.1](docs/releases/v0.7.1.md) · [v0.7.0](docs/releases/v0.7.0.md) · [v0.6.0](docs/releases/v0.6.0.md) · [v0.5.0](docs/releases/v0.5.0.md) · [v0.4.0](docs/releases/v0.4.0.md) · [v0.3.0](docs/releases/v0.3.0.md) · [v0.2.0](docs/releases/v0.2.0.md) · [v0.1.0](docs/releases/v0.1.0.md)
