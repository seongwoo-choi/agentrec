...
[릴리스 노트](docs/releases/v0.11.0.md) ·
...
> **상태:** v0.11.0이 최신 릴리스입니다. Viewer의 모든 실행 검색은 이제 저장된
> 저장소 변경 경로를 찾고, 페이지가 나뉜 변경 목록의 정확한 행과 inspector를 엽니다.
> patch와 파일 내용은 계속 검색 색인에 포함하지 않습니다.
>
